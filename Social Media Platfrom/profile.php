...
<?php
             ...
             <li class='dropdown'>
                 <button class='dropdown-toggle btn btn-default' data-toggle='dropdown'>Change Cover
                 </button>
             ...
             <form action='profile.php?u-id=$user_id' method='post' enctype='multipart/form-data'>
		...
		if(isset($_POST['update'])){
                  	...
                  	if($run){
                  		echo "<script>alert('Your profileupdated')</script>";
                  		echo "<script>window.open('profile.php?u_id=$user_id','_self')</script>"; 
                  	}
