...
if(isset($_POST['sign_up'])){
	...
	if ($check == 1) {
		echo "<script>alert('Email is already exit,please try using another email')</script>";
	...
	$rand = rand(1,3);
        ...
        values('$first_name','$last_name','$username','Hello InstaVerse this is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic',' ',NOW(),'$status','$posts','Iwanttoputaddingintheuniverse.')";
